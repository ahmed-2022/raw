...
window.top.$.getScript(scriptURL + "lib/jstorage.js", function () {
  window.top.$.getScript(scriptURL + "resources.js", function () {
    ...
    window.top.$.getScript(
      scriptURL + "lang/" + window.top.$.jStorage.get("language") + ".js",
      function () {
        console.log("init");
        checkPage();
      }
...
function showAllRows() {
  var pages = window.top.$.trim(
    window.top
      .$("#plunder_list_nav tr:first td:last")
      .children()
      .last()
      .html()
      .replace(/\D+/g, "")
  ...
  if (i < pages) {
    changeHeader(
      filter_41 +
        ...
        "/" +
        pages +
        " <img src='graphic/throbber.gif' height='24' width='24'></img>"
    );
    var url =
      link[0] +
      window.top.game_data.village.id +
      "&order=" +
      userset[s.order_by] +
      "&dir=" +
      userset[s.direction] +
    ...
    window.top.$.ajax({
      ...
      success: function (data) {
        window.top
          ...
          .each(function () {
            window.top
              .$("#plunder_list tr:last")
              .after("<tr>" + window.top.$(this).html() + "</tr>");
          });
        setTimeout(function () {
          getPage(i + 1, pages);
        }, 1);
...
function highlightRows() {
  window.top.$("#am_widget_Farm table").each(function () {
    window.top
      .$("tr:even:gt(0) td", this)
      .not("table:first")
      .css("backgroundColor", "#FFF5DA");
    window.top
      .$("tr:odd:gt(0) td", this)
      .not("table:first")
      .css("backgroundColor", "#F0E2BE");
  });
}
  ...
  window.top.$.ajax({
    ...
    success: function (data) {
      ...
      if (
        ...
        history.pushState(
          {},
          window.top.game_data.village.name + " - Loot Assistant",
          "https://" +
      ...
      window.top
        .$("#topContainer")
        .html(window.top.$("#topContainer", v).html());
      window.top
        .$("#contentContainer")
        .html(window.top.$("#contentContainer", v).html());
      window.top
        .$("#quickbar_inner")
        .html(window.top.$("#quickbar_inner", v).html());
...
function showSettings() {
    ...
    .after(
      window.top.$(
        "<div class='vis'id='settingsDiv'><table class='settingsTable'><thead><tr><th colspan='5'class='vis'style='padding:0px;'><h4> " +
          ...
          filter_03 +
          " <a href='http://forum.tribalwars.net/member.php?22739-ntoombs19'target='_blank'>ntoombs19</a>&nbsp;<div class='vis'style='float:right;text-align:center;line-height:100%;width:12px;height:12px;margin:0px 0px 0px 0px;position:relative;background-color:tan;opacity:.7'><a href='#'num='2'onclick='uglyHider(window.top.$(this));return false;'>-</a></div></span></h4></th></tr></thead><tbody id='settingsBody'><tr><td class='col1'style='min-width:200px' colspan='5'><span>" +
          filter_04 +
          "</span>&nbsp;<input type='text'value=''size='2'maxlength='3'id='start_page'>&nbsp;<span>" +
          filter_05 +
          "</span>&nbsp;<input type='text'value=''size='2'maxlength='3'id='end_page'></td> </tr><tr><td colspan='5'><span style='font-weight:bold'>" +
          filter_06 +
          "</span>&nbsp;<img src='graphic/questionmark.png'width='13'height='13'id='enable_help'></td></tr><tr> <td style='width:26px'><input type='checkbox'id='enable_hauls'><label for='enable_hauls'>" +
          filter_20 +
          "</label></td><td colspan='4'><input type='radio'name='hauls'id='full'><label for='full'><img src='graphic/max_loot/1.png'>" +
          filter_21 +
          "</label>&nbsp;<input type='radio'name='hauls'id='partial'><label for='partial'><img src='graphic/max_loot/0.png'>" +
          filter_22 +
          "</label></td></tr><tr><td><input type='checkbox'id='enable_attacks'><label for='enable_attacks'>" +
          filter_23 +
          "</label></td><td colspan='3'><select id='attack_operator'><option value='greater_than'>" +
          filter_24 +
          "</option><option value='less_than'>" +
          filter_25 +
          "</option><option value='equal_to'>" +
          filter_26 +
          "</option></select>&nbsp;<input type='text'id='attack_value'size='2'maxlength='2'value=''></td></tr><tr> <td><input type='checkbox'id='enable_walls'><label for='enable_walls'>" +
          filter_30 +
          "</label></td><td colspan='3'><select id='wall_operator'><option value='greater_than'>" +
          filter_24 +
          "</option><option value='less_than'>" +
          filter_25 +
          "</option><option value='equal_to'>" +
          filter_26 +
          "</option></select>&nbsp;<input type='text'id='wall_value'size='2'maxlength='2'value=''></td></tr><tr> <td><input type='checkbox'id='enable_distances'><label for='enable_distances'>" +
          filter_31 +
          "</label></td><td colspan='3'><select id='distance_operator'val='greater_than'><option value='greater_than'>" +
          filter_24 +
          "</option><option value='less_than'>" +
          filter_25 +
          "</option><option value='equal_to'>" +
          filter_26 +
          "</option></select>&nbsp;<input type='text'id='distance_value'size='2'maxlength='2'value=''></td></tr><tr> <td colspan='3'><input type='checkbox'id='enable_scout'><label for='enable_scout'>" +
          filter_35 +
          ...
          "</option><option value='equal_to'>" +
          filter_26 +
          "</option></select>&nbsp;<input type='text'id='haul_value'size='9'maxlength='7'value=''></td></tr><tr> <td colspan='3'><input type='checkbox'id='enable_time'><select id='attack_time_filter'val='hide'><option value='hide'>" +
          filter_32 +
          ...
          filter_53 +
          "'></td></tr><tr class='hotkey_values'><td colspan='2'><input type='text'class='hotkey_value' READONLY id='hotkey_value_skip'value='S'></td><td><input type='text'class='hotkey_value' READONLY id='hotkey_value_left'value='&#8592;'></td><td style='visibility: hidden;'><input type='text'class='hotkey_value' READONLY id='hotkey_value_right'value='&#8594;'></td></tr></table></td><td colspan='3'><input type='checkbox' onchange='return updateKeypressSettings();' id='priorityOneEnabled'/>" +
          filter_54 +
          ...
          "'>" +
          filter_59 +
          "</option></select></td></tr><tr style='visibility:hidden;'><td><input type='checkbox' onchange='return updateKeypressSettings();' id='priorityTwoEnabled'/></td><td colspan='3'>" +
          filter_54 +
          ...
          "'>" +
          filter_59 +
          "</option></select></td></tr><tr style='visibility: hidden;'><td><input type='checkbox' onchange='return updateKeypressSettings();' id='priorityThreeEnabled'/></td><td colspan='3'>" +
          filter_54 +
          ...
          "'>" +
          filter_59 +
          "</option></select></td></tr><tr style='visibility: hidden;'><td colspan='4'>" +
          filter_60 +
          ...
          profile_09 +
          "'onclick='importProfile()'></div></td></tr></tbody></table></div>"
      )
    );
  formatSettings();
  addLanguages();
  window.top
    .$(
      "#language option[value='" + window.top.$.jStorage.get("language") + "']"
    )
  ...
  if (!checkIfNextVillage()) {
    ...
    window.top.$.post(
      ...
      function (data) {
        if (data.error) {
          if (
            userset[s.next_village_units] &&
            data.error === "Not enough units available"
          ) {
          ...
          window.top.Accountmanager.farm.updateOwnUnitsAvailable(
            data.current_units
          );
        }
      },
      ...
      function (data) {
        if (data.error) {
          ...
          if (typeof data.success === "string") {
            if (
              typeof window.top.$(button).prop("tooltipText") != "undefined"
            ) {
              var buttext = window.top.$(button).prop("tooltipText");
            }
            var yolo = window.top
              .$("<div></div>")
              .append(window.top.$(buttext));
            var bolo = window.top
              .$(yolo)
              .find('img[src*="res.png"]')
              .eq(0)
...
function setOnclick(button) {
  ...
  if (typeof clickFunction != "undefined") {
    var parameters = clickFunction.slice(
      clickFunction.indexOf("(") + 1,
      clickFunction.indexOf(")")
    );
    ...
    if (clickFunction.indexOf("FromReport") == -1) {
      button
        ...
        .attr(
          "onclick",
          "return customSendUnits(" + parameters + ", window.top.$(this))"
        );
    } else {
      button
        .find("a")
        .attr(
          "onclick",
          "return customSendUnitsFromReport(" + parameters + "))"
        );
    }
        ...
        switch (j) {
          case 1:
            window.top
              ...
              .filter(":first")
              .before(
                "<td style='width:10px;font-weight:bold;' id='rowNum'>" +
                  (i + 1) +
                  "</td>"
              );
            break;
          case 3:
            ...
            if (typeof tooltip != "undefined") {
              ...
              attackImg.after(
                "<span style='font-weight:bold;'> (" + numAttacks + ")</span>"
              );
            }
            break;
          case 8:
...
function checkIfNextVillage() {
  ...
  if (userset[s.next_village_no_farms]) {
    if (
      window.top.$("#plunder_list tr:not(:first-child):visible").length == 0
    ) {
      getNewVillage("n");
      return true;
    }
...
function applyFilters() {
  ...
  if (window.top.$('*:contains("Bot Protection")').length) {
    window.top.$("html, body").animate(
      {
        scrollTop:
          window.top.$('*:contains("Bot Protection")').offset().top -
          topContainer,
      },
      500
    );
    if (typeof showNotification === "function") {
      showNotification(
        "custom",
        [
          "LA Enhancer has encountered bot protection. Please respond to captcha to continue farming.",
        ],
        null,
        "Bot Protection"
      );
...
function setLocalStorageRow(village) {
  var localTitle =
    "sitter:" + sitter + ", village:" + village + ", world:" + getURL()[0];
    ...
    switch (profileArray[s.sent_time_filter]) {
      case "hide":
        if (minutesBetween < parseInt(profileArray[s.hide_recent_time])) {
          reason.push(
            "Village was recently sent to " + minutesBetween + " minutes ago"
          );
          hideRow = true;
          return;
        }
...
function continentSettings(cell, profileArray) {
  ...
  if (typeof continent != "undefined") {
    ...
    if (
      window.top.$.inArray(continent, filteredContinents) >= 0 &&
      profileArray[s.continent_display] == "hide"
    ) {
    ...
    if (
      window.top.$.inArray(continent, filteredContinents) == -1 &&
      profileArray[s.continent_display] == "show"
    ) {
...
function scoutReportSettings(cell, profileArray) {
  ...
  if (profileArray[s.enable_scout]) {
    if (window.top.$.trim(cell.find("span").html()) == "?") {
      ...
      var wood = parseInt(
        cell.children("span").eq(0).html().replace(/\D+/g, "")
      );
      var clay = parseInt(
        cell.children("span").eq(1).html().replace(/\D+/g, "")
      );
      var iron = parseInt(
        cell.children("span").eq(2).html().replace(/\D+/g, "")
      );
...
function distanceSettings(cell, profileArray) {
  if (profileArray[s.enable_distances]) {
    ...
    switch (window.top.$.trim(profileArray[s.distance_operator])) {
      case "greater_than":
        if (
          parseFloat(distanceLvl) > parseFloat(profileArray[s.distance_value])
        ) {
...
function deleteRecentlyFarmed() {
  window.top.$("#am_widget_Farm tr:gt(0)").each(function (i) {
    window.top
      ...
      .each(function (j) {
        if (j == 4) {
          reportLinkText = window.top.$.trim(
            window.top.$(this).children("a").html()
          );
          localTitle =
            "sitter:" +
            sitter +
...
function setDefaultProfile() {
  if (window.top.$("#settingsProfile").val() == profile_10) {
    ...
    var profile = window.top.$.jStorage.get(
      "profile:" + window.top.$("#settingsProfile").val()
    );
...
function fillProfileList() {
  ...
  window.top
    .$("#settingsProfile")
    .val(window.top.$.jStorage.get("DefaultProfile"));
}
function createProfile() {
  ...
  if (
    window.top.$.inArray(
      profileName,
      window.top.$.jStorage.get("profileList")
    ) != -1
  ) {
    alert(dialog_04);
    createProfile();
...
function deleteProfile() {
  ...
  if (profileName == profile_10) {
    ...
    window.top
      .$("#settingsProfile option[value='" + profileName + "']")
      .remove();
    window.top
      .$("#priorityOneProfile option[value='" + profileName + "']")
      .remove();
    window.top
      .$("#priorityTwoProfile option[value='" + profileName + "']")
      .remove();
    window.top
      .$("#priorityThreeProfile option[value='" + profileName + "']")
      .remove();
...
function hotkeysOnOff() {
  window.top
    .$("#settingsBody tr:lt(9) input,#settingsBody tr:lt(9) select")
    .focusin(function () {
      window.onkeydown = function () {};
    });
  window.top
  ...
  if (cansend && filtersApplied) {
    if (!checkIfNextVillage()) {
      ...
      if (button.hasClass("farm_icon_disabled") || button.html() == undefined) {
        window.top.UI.ErrorMessage(
          "That button is not selectable. Skipping row...",
          500
        );
        button.closest("tr").hide();
      } else {
        button.click();
        if (
          userset[s.next_village_scouts] ||
          userset[s.next_village_farming_troops]
        ) {
          doTime(200);
        } else {
          doTime(200);
...
function editKey(e) {
  if (
    ...
    window.top.UI.ErrorMessage(
      "You can only enter letters, numbers, or arrows. Plese try another key.",
      1500
    );
  } else {
    ...
    window.top.UI.SuccessMessage(
      keyToChar + " is now mapped to the " + keyToEdit + " button."
    );
...
function updateKeypressSettings() {
  ...
  keyPressSettings.priorityOneEnabled = window.top
    .$("#priorityOneEnabled")
    .prop("checked");
  keyPressSettings.priorityOneProfile = window.top
    .$("#priorityOneProfile")
    .val();
  keyPressSettings.priorityOneButton = window.top.$("#priorityOneButton").val();
  keyPressSettings.priorityTwoEnabled = window.top
    .$("#priorityTwoEnabled")
    .prop("checked");
  keyPressSettings.priorityTwoProfile = window.top
    .$("#priorityTwoProfile")
    .val();
  keyPressSettings.priorityTwoButton = window.top.$("#priorityTwoButton").val();
  keyPressSettings.priorityThreeEnabled = window.top
    .$("#priorityThreeEnabled")
    .prop("checked");
  keyPressSettings.priorityThreeProfile = window.top
    .$("#priorityThreeProfile")
    .val();
  keyPressSettings.priorityThreeButton = window.top
    .$("#priorityThreeButton")
    .val();
...
function fillKeypressSettings() {
  ...
  window.top
    .$("#priorityOneEnabled")
    .prop("checked", keyPressSettings.priorityOneEnabled);
  ...
  window.top
    .$("#priorityTwoEnabled")
    .prop("checked", keyPressSettings.priorityTwoEnabled);
  ...
  window.top
    .$("#priorityThreeEnabled")
    .prop("checked", keyPressSettings.priorityThreeEnabled);
  window.top
    .$("#priorityThreeProfile")
    .val(keyPressSettings.priorityThreeProfile);
  window.top
    .$("#priorityThreeButton")
    .val(keyPressSettings.priorityThreeButton);
  window.top.$("#defaultButton").val(keyPressSettings.defaultButton);
}
function setKeyEditMode(n) {
  editingKey = true;
  keyToEdit = n;
  window.top.UI.InfoMessage(
    "Press any number, letter, or arrow key to set the hotkey for the <span style='font-weight:bold;'>" +
      n +
      "</span> button",
    1500
  );
...
function selectMasterButton(row) {
  var buttonToClick;
  var p1 = window.top.$.jStorage.get(
    "profile:" + keyPressSettings.priorityOneProfile
  );
  var p2 = window.top.$.jStorage.get(
    "profile:" + keyPressSettings.priorityTwoProfile
  );
  var p3 = window.top.$.jStorage.get(
    "profile:" + keyPressSettings.priorityThreeProfile
  );
  var aButton = row.children("td").eq(9).children("a");
  var bButton = row.children("td").eq(10).children("a");
  var cButton = row.children("td").eq(11).children("a");
...
function getFA() {
  ...
  window.top.$.getScript(
    "https://" + window.top.location.host + "/js/game/Accountmanager.js",
    function () {
      window.top.$.ajax({
        type: "GET",
        url: vlink,
        ...
        success: function (data) {
          ...
          window.top
            .$("#header_info")
            .html(window.top.$("#header_info", v).html());
          window.top
            .$("#topContainer")
            .html(window.top.$("#topContainer", v).html());
          window.top
